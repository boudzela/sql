...
-- MOM total number of applications and other figures  
with CTE as ( 
...
order by month(issue_date);  
 ...
 -- let's look into every month installment payments by debtors - 
 -- amount paid by each month to the bank by debtors -- 
